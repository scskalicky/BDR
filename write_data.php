...
$name = "norming_data/" . $subject . "_results.csv"; 

// write the file to disk
file_put_contents($name, $data);


// open master csv file - should create the file if the file doesn't exist
$handle = fopen("norming_data/completions.csv", "a");
